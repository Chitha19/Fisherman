...
public class State1 extends JPanel implements ActionListener{
	...
	private final ImageIcon imgstate2 = new ImageIcon(this.getClass().getResource("Background2.jpg"));
	...
	ImageIcon feildover = new ImageIcon(this.getClass().getResource("BackgroundGO.jpg"));
